...
import net.vodculen.drogenmissbrauch.item.weapon.MarzipanClaymoreItem;
...
public class ModItems {
	...
	public static final Item MARZIPAN_CLAYMORE = registerItem("marzipan_claymore", new MarzipanClaymoreItem(new Item.Settings().food(
		new FoodComponent.Builder().hunger(2).saturationModifier(1.2F).alwaysEdible().build())));
